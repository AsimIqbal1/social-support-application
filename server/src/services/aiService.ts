...
export const generateMockResponse = (
  ...
  const contextInfo = context
    ? ` (Based on your context: ${Object.entries(context)
...
export const generateAIContent = async (
  ...
  console.log(
    `🤖 Generating AI content for field: ${field}, language: ${language}`
  );
  ...
  try {
    ...
    console.log(
      `✅ AI content generated successfully, tokens used: ${usage.totalTokens}`
    );
