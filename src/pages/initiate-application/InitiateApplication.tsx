...
const initialFormData: CompleteApplicationFormData = {
    ...
    familyFinancial: {
        maritalStatus: '', // User must select
        dependents: undefined, // User must input
        employmentStatus: '', // User must select
        monthlyIncome: undefined, // User must input
        housingStatus: '', // User must select
    },
